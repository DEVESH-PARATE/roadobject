...
def main(image_path = None, video_path = None, video_out = None,webcam=None):
    ...
    model =  torch.hub.load("C:/Users/parat/OneDrive/Desktop/Detections/yolov7", 'custom', source ='local', path_or_model='C:/Users/parat/OneDrive/Desktop/Detections/models/best.pt', force_reload=True) ### The model is stored locally
    class_names = model.names ### class names in string format
    # print(class_names)        

    model_obj =  torch.hub.load("C:/Users/parat/OneDrive/Desktop/Detections/yolov7/", 'custom', source ='local', path_or_model='C:/Users/parat/OneDrive/Desktop/Detections/models/yolov7.pt', force_reload=True) ### The model is stored locally
...
main(video_path=r"2.mp4", video_out="result.mp4")
